        ...
        *,
        ...
        if isinstance(playlist, dict):
            ...
            if isinstance(track_ids, list):
                deduped = unique_in_order(
                    track_ids
                )  # Needed since API returns concatenated tracklist for folders
            ...
            if ids is None:
                ...
                if validation == "warn":  # pragma: no branch - strict raises above
                    self._logger.warning(
                        "Invalid playlist_ids for get_many: %s", playlist_ids
                    )
                    return None
    ...
    def get_path(
        ...
        *,
        ...
        if not isinstance(playlist_id, int) or playlist_id < 1:
            ...
            if validation == "warn":
                self._logger.warning(
                    "Invalid playlist_id for get_path: %s", playlist_id
                )
            return None
        ...
        *,
        ...
        if smartlist is not None:
            ...
            if normalized_smartlist is None:
                ...
                if validation == "warn":  # pragma: no branch - strict raises above
                    self._logger.warning(
                        "Invalid smartlist payload for add: %s", smartlist
                    )
                    return None
        ...
        *,
        ...
        if smartlist is not None:
            ...
            if normalized_smartlist is None:
                ...
                if validation == "warn":  # pragma: no branch - strict raises above
                    self._logger.warning(
                        "Invalid smartlist payload for update: %s", smartlist
                    )
                    return None
            smartlist = normalized_smartlist
        ...
        if isinstance(playlist, dict):
            ...
            if isinstance(track_ids, list):
                ...
                if len(deduped) != len(
                    track_ids
                ):  # pragma: no branch - exercised by tests
                    playlist = dict(playlist)
                    playlist["trackIds"] = deduped
            return cast(PlaylistResponse, playlist)
        ...
        *,
        ...
        if validation == "off":
            ...
            if ids is None:
                ...
                if validation == "warn":  # pragma: no branch - strict raises above
                    self._logger.warning(
                        "Invalid playlist_ids for delete: %s", playlist_ids
                    )
                    return False
            payload = {"ids": ids}
    ...
    def get_by_path(
        ...
        *,
        ...
        if normalized_path is None:
            ...
            if validation == "warn":  # pragma: no branch - strict raises above
                self._logger.warning(
                    "Invalid playlist_path for get_by_path: %s", playlist_path
                )
            return None
        ...
        try:
            ...
            if validation == "warn":  # pragma: no branch - strict raises above
                self._logger.warning(
                    "Invalid playlist_type for get_by_path: %s", playlist_type
                )
                return None
